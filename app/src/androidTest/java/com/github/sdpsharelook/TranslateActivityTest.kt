...
class TranslateActivityTest {
    ...
    fun testTranslateActivity() = runTest {
        ...
        // simple translate
        selectLanguage("fr", R.id.buttonSourceLang)
        selectLanguage("en", R.id.buttonTargetLang)
        ...
        // change target lang
        selectLanguage("it", R.id.buttonTargetLang)
    ...
    fun testSwitchButtonMustSwitchLanguagesAndRunTranslation() {
        ...
        onView(withId(R.id.buttonSwitchLang)).perform(click())
        onView(withId(R.id.buttonSourceLang)).check(matches(withSpinnerText("en")))
        onView(withId(R.id.buttonTargetLang)).check(matches(withSpinnerText("fr")))
        onView(withId(R.id.targetText)).check(matches(withText("Bonjour.")))
    }
