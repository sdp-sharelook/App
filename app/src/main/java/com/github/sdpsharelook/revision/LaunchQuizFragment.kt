 ...
 * Use the [LaunchQuizFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class LaunchQuizFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment LaunchQuizFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic fun newInstance(param1: String, param2: String) =
                LaunchQuizFragment().apply {
